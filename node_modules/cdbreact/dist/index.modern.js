...
import React, { useState, createRef, useCallback, Fragment, Component as Component$F, createContext, useContext, useEffect, forwardRef } from 'react';
import PropTypes from 'prop-types';
import classNames from 'classnames';
import styled, { ThemeProvider, css, keyframes } from 'styled-components';
import { colorStyle, space, variant, color } from 'styled-system';
...
var Component$4 = styled.span(_templateObject$4(), space, colorStyle, function (props) {
...
var Component$7 = styled.div(_templateObject$7(), function (props) {
  ...
  return props.circle === true ? css(_templateObject2$3()) : css(_templateObject3());
}, function (props) {
  return props.outline === true ? css(_templateObject4(), function (props) {
...
var Button$1 = function Button(props) {
  ...
  return /*#__PURE__*/React.createElement(ThemeProvider, {
    theme: theme
  }, /*#__PURE__*/React.createElement(Component$7, _extends({
    "data-test": "button",
...
var Component$e = styled.div(_templateObject$f());
...
var Input = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var renderFunction = function renderFunction() {
      return /*#__PURE__*/React.createElement(ThemeProvider, {
        theme: theme
      }, /*#__PURE__*/React.createElement(React.Fragment, null, icon && /*#__PURE__*/React.createElement("i", _extends({
        "data-test": "fa",
        icon: icon,
        size: iconSize,
        brand: iconBrand,
      ...
      }, attributes)), /*#__PURE__*/React.createElement(TagInput, _extends({
        "data-test": dataTest
      }, attributes, {
        className: classes,
        id: id,
    ...
    return noTag ? renderFunction() : /*#__PURE__*/React.createElement(Component$e, {
...
var Component$f = styled.ul(_templateObject$g(), colorStyle, function (props) {
  return props.sm ? css(_templateObject2$6()) : css(_templateObject3$3());
}, function (props) {
  return props.circle ? "50%" : "0";
...
var Component$j = styled.button(_templateObject$k(), colorStyle, space, function (props) {
  return props.circle === true ? css(_templateObject2$7()) : css(_templateObject3$4());
}, variant({
  prop: "size",
  variants: {
    lg: {
...
var Caret = styled.span(_templateObject4$2(), function (props) {
  return props.dropup ? css(_templateObject5$2()) : props.dropleft ? css(_templateObject6()) : props.dropright ? css(_templateObject7()) : css(_templateObject8());
}, function (props) {
...
var Container$2 = styled.div(_templateObject2$8(), function (props) {
...
var SidebarInner = styled.div(_templateObject2$9());
var SidebarLayout = styled.div(_templateObject3$5());
...
var MenuUl = styled.ul(_templateObject2$a(), function (props) {
  return props.textColor;
}, function (props) {
  return props.textColor;
}, function (props) {
...
var InnerMenuItem = styled.div(_templateObject$H());
var InnerMenuLi = styled.li(_templateObject2$b());
...
var rotator = keyframes(_templateObject$I());
var colors$1 = keyframes(_templateObject2$c());
var dash = keyframes(_templateObject3$6());
var Component$C = styled.svg(_templateObject4$3(), rotator);
var Circle = styled.circle(_templateObject5$3(), function (props) {
  ...
  return props.multicolor ? css(_templateObject6$1(), dash, colors$1) : css(_templateObject7$1(), dash);
});
...
var Component$D = styled.div(_templateObject$J());
...
var Component$E = styled.div(_templateObject$K(), function (props) {
  props.zoom ? css(_templateObject2$d()) : css(_templateObject3$7());
}, function (props) {
